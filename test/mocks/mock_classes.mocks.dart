...
// in my_appp/test/mocks/mock_classes.dart.
...
import 'package:my_appp/domain/data/local/sqflite_storage.dart' as _i10;
...
/// A class which mocks [SqfliteStorage].
///
/// See the documentation for Mockito's code generation for more information.
class MockSqfliteStorage extends _i1.Mock implements _i10.SqfliteStorage {
  MockSqfliteStorage() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i8.Future<void> put(String? key, Map<String, dynamic>? value) =>
      (super.noSuchMethod(
  ...
  @override
  _i8.Future<List<Map<String, dynamic>>> getAll() =>
      (super.noSuchMethod(
